#!/usr/bin/env python3
"""
VERIFICA SINCRONIZZAZIONE DATABASE - FIXED
"""
import sqlite3
import requests
import hmac
...
print("🔍 VERIFICA SINCRONIZZAZIONE - FIXED")
print("="*50)
...
db_balance = result[0] if result else 0
...
difference = abs(usdt_balance - db_balance)
if difference < 1.0:
    print(f"\n✅ SINCRONIZZAZIONE PERFETTA! (Differenza: ${difference:.2f})")
else:
    print(f"\n⚠️  Piccola differenza: ${difference:.2f}")
    print("💡 Questo è normale per piccole discrepanze di arrotondamento")
