...
📝 <b>Motivo:</b> {exit_reason}
    ...
    def run(self, backtest_symbol: str = None, backtest_start: str = None, backtest_end: str = None):
        ...
        print(f"{'
    # 🔧 CONFIGURAZIONE FORZATA - INIZIO
    print("🎯 CONFIGURAZIONE FORZATA ATTIVA:")
    print(f"   • Risk/Trade: 0.3% (era 2.0%)")
    print(f"   • Symbols: ['ETHUSDT'] (era BTC,ETH,SOL)")
    print(f"   • Max Positions: 1 (era 3)")
    print(f"   • Take Profit: 1.5% (era 3.0%)")
    print(f"   • Stop Loss: 0.8% (era 1.5%)")
    print(f"   • Dashboard Port: 8001 (era 8000)")
    # 🔧 CONFIGURAZIONE FORZATA - FINE
='*80}")
